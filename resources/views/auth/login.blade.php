...
<head>
        ...
        <!-- Bootstrap Css -->
        <link id="style" href="{{ asset('dash') }}/build/assets/libs/bootstrap/css/bootstrap.min.css" rel="stylesheet" >

        <!-- ICONS CSS -->
        <link href="{{ asset('dash') }}/build/assets/icon-fonts/icons.css" rel="stylesheet">

        <!-- APP CSS & APP SCSS -->
        <link rel="preload" as="style" href="{{ asset('dash') }}/build/assets/app-BXaKe1N-.css" /><link rel="stylesheet" href="{{ asset('dash') }}/build/assets/app-BXaKe1N-.css" />
	...
	<body class="bg-white">
                        ...
                        <div class="card custom-card my-auto border">
                            <div class="card-body p-5">
                                ...
                                <form action="{{ route('authenticate') }}" method="post">
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-xl-12">
                                            <label for="nim-nip" class="form-label text-default">NIM/NIP</label>
                                            <input type="text" class="form-control" id="nim-nip" name="nim" placeholder="Masukkan NIM/NIP">
                                        </div>
                                        <div class="col-xl-12 mb-2">
                                            <label for="signin-password" class="form-label text-default d-block">Password<a href="#" class="float-end fw-normal text-muted">Lupa password?</a></label>
                                            <div class="position-relative">
                                                <input type="password" class="form-control create-password-input" id="signin-password" name="password" placeholder="password">
        ...
        <!-- Show Password JS -->
        <script src="{{ asset('dash') }}/build/assets/show-password.js"></script>
